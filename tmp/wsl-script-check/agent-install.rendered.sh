...
API_BASE='https://control.example.com'
NODE_ID='node_demo'
AGENT_TOKEN='agent-token-demo'
AGENT_VERSION='0.1.17'
AGENT_INSTALL_URL='https://control.example.com/api/nodes/agent/install?nodeId=node_demo'
NODE_NETWORK_TYPE='public'
NODE_PRIMARY_DOMAIN='edge.example.com'
NODE_BACKUP_DOMAIN='backup.example.com'
NODE_ENTRY_IP='203.0.113.10'
GITHUB_MIRROR_URL=''
NODE_INSTALL_WARP=1
NODE_WARP_LICENSE_KEY='warp-license-demo'
...
USE_SYSTEMD=0
INSTALL_MODE=""
HEARTBEAT_INTERVAL_SECONDS_DEFAULT='30'
VERSION_PULL_INTERVAL_SECONDS_DEFAULT='60'
HEARTBEAT_INTERVAL_SECONDS='30'
VERSION_PULL_INTERVAL_SECONDS='60'
BOOTSTRAP_CERT_PATH=""
BOOTSTRAP_KEY_PATH=""
TMP_DIR=""
